...
class SpaViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for st in data{
            if(ud.bool(forKey: "isSaved") == true){
                if(st.currentUser == true && st.feedback?.type != nil && st.feedback?.type != "room" && st.feedback?.type != "food"){
    ...
    */
    ...
    @IBAction func submitUser(_ sender: UIButton) {
        ...
        FeedbackViewController.avgStarsValue3 = (FeedbackViewController.starValues1 + FeedbackViewController.starValues2 + FeedbackViewController.starValues3 + FeedbackViewController.starValues4 + FeedbackViewController.starValues5) / 5.0
        print(FeedbackViewController.avgStarsValue3)
