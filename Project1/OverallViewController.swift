...
class OverallViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for st in data{
            if(ud.bool(forKey: "isSaved") == true){
                if(st.currentUser == true && st.feedback?.type != nil && st.feedback?.type != "room" && st.feedback?.type != "food" && st.feedback?.type != "spa" && st.feedback?.type != "gym"){
    ...
    */
    @IBAction func submitUser(_ sender: UIButton) {
        ...
        FeedbackViewController.avgStarsValue5 = (FeedbackViewController.starValues1 + FeedbackViewController.starValues2 + FeedbackViewController.starValues3 + FeedbackViewController.starValues4 + FeedbackViewController.starValues5) / 5.0
        print(FeedbackViewController.avgStarsValue5)
               }
